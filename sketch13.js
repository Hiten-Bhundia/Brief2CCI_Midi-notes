// ------------------------------------------------------------
// 4-Dataset Harmony Visualiser (Clean Version)
// ------------------------------------------------------------
...
function setup() {
  ...
  button1detached.size(50, 50);
  button2detached = createButton("2D");
  button2detached.size(50, 50);
  button1joint = createButton("1J");
  button1joint.size(50, 50);
  button2joint = createButton("2J");
  button2joint.size(50, 50);
...
function highlightActiveButton() {
  ...
  if (currentData === Detached1) {
    button1detached.style("background-color", "gold");
    button1detached.style("color", "white");
  }
  else if (currentData === Detached2) {
    button2detached.style("background-color", "gold");
    button2detached.style("color", "white");
  }
  else if (currentData === Joint1) {
    button1joint.style("background-color", "gold");
    button1joint.style("color", "white");
  }
  else if (currentData === Joint2) {
    button2joint.style("background-color", "gold");
    button2joint.style("color", "white");
  }
}
